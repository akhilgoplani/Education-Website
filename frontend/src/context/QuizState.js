...
const QuizState = (props) => {
  ...
  const addQuiz = async (question, option1, option2, option3, option4, answer, title) => {
    ...
    const response = await fetch(`${host}/api/quiz/addquiz`, {
      ...
      body: JSON.stringify({question, option1, option2, option3, option4, answer,title})
    });
  ...
  // Edit a Quiz
  const editQuiz = async (id, question, option1, option2, option3, option4, answer, title,code) => {
    // API Call 
